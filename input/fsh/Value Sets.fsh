...
// * include codes from system $211HSIS where concept is-a #Level2
// * exclude codes from system $211HSIS where concept is-a #Level1Y-TargetPopulations
...
// * include codes from system $211HSIS where concept is-a #Level3-6
// * exclude codes from system $211HSIS where concept is-a #Level1Y-TargetPopulations