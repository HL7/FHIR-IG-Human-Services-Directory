...
* text  -> "	GAP	FHIR Organization.text is datatype Narrative so the HSDS organization.description (A brief summary about the organization. It can contain markup such as HTML or Markdown.) does not correctly map to this FHIR element. Should FHIR Organization.text be used for a generated narrative from HSDS elements to fully describe the most pertinent organization fields for display purposes?	"
