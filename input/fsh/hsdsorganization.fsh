...
* id  -> "	phone.organization_id	The identifier of the organization for which this is the phone number	"
...
* partOf  -> "	GAP		"
// * contact  -> "	contact Table	The HSDS contact table contains details of the named contacts for services and organizations. 	"
